for (var i = 1; i < 2; i++) {
    ...
    $('.salestable').append(`<tr  class=" m-0 row text-center">
      ...
      <td  class="col-md-3 p-0"><input required list="itemnamelist" class="form-control" name="itemname" id="itemname-${i}" type="text" required oninvalid="this.setCustomValidity('Item not in the list!!')"/></td>
